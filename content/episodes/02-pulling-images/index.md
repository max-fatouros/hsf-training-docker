...
questions = ['How are images downloaded?', 'How are images distinguished?']
teaching = 10
...
{{< callout type="note" title="Docker Hub and Podman" >}}
...
{{< callout type="note" title="Connection errors" >}}
...
{{< challenge title="Pulling Python" >}}
