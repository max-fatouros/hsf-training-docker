...
questions = ['How do containers interact with my local file system?']
teaching = 15
...
{{< callout type="note" title="Permission issues" >}}
...
{{< callout type="note" title="No such file or directory?" >}}
...
<figure>
{{< lesson/image src="/fig/macos_volume_mounting.svg" alt="Volume mounting on macOS diagram" width="800px" >}}
  <figcaption>
